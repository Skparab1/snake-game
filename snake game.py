...
def removeballatfront(linescan):
...
def addball(line):
    ...
    line = linepart1 + 'ooooo' + linepart2
    return line
pos = 50
l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18 = ' '*99,' '*99,' '*99,' '*99,' '*99,' '*99,' '*99,' '*99,' '*99,' '*99,((' '*3)+'ooooo'+(' '*90)),' '*99,' '*99,' '*99,' '*99,' '*99,' '*99,' '*99
direction = 'right'
while True:
    try:
        time.sleep(0.1)
